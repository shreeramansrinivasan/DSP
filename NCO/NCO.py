...
class NCO:
    ...
    def lookup_output(self):
        return self.sine_table.table[self.accum_val >> int(math.log2((self.phase_accumulator_frac_bitwidth)))]
...
#tests 
input_frequency = 100e3
frequency_word = 1 # Start with frequency word 1/32  
integer_bitwidth = 16
